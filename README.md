...
- Navigate to "Options" 
  ...
  - Click the "Display" tab, tick "Fullscreen", set Anisotropic Filtering to 16x and FXAA to "high"
  - Click the "Graphics" tab and set all options to "high". In case you get poor FPS then undo these changes.
...
These steps should give you a first impression. If you would like to gain a deeper understanding you should check out the [Asset Migration Path](#assets-migration-path).
